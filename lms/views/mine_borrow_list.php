            ...
            <div class="layui-tab-item layui-show">
                ...
                <div style="margin-top:30px">
                    <table class="layui-table" lay-filter="test"
                        lay-data="{url:'./borrow_get.php', page: true, limit: 6, limits:[6]}"
                        id="ID-table-demo-theads-1">
                        <thead>
                            <tr>
                                <th lay-data="{field:'book_id'}" rowspan="2">图书编号</th>
                                <th lay-data="{field:'book_name'}" rowspan="2">图书名称</th>
                                <th lay-data="{field:'borrow_num'}" rowspan="2">申请数量</th>
                                <th lay-data="{field:'state'}" rowspan="2">申请状态</th>
